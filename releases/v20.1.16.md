...
- A correctness bug, which caused [partitioned](../v20.1/partitioning.html) index scans to omit rows where the value of the first index column was `NULL`, has been fixed. This bug was present since v19.2.0. [#64050][#64050]
- Fixed a bug where multiple concurrent invocations of [`cockroach debug zip`](../v20.1/cockroach-debug-zip.html) could yield cluster instability. This bug had been present since CockroachDB v20.1. [#64086][#64086]
